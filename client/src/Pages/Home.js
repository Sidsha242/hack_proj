            ...
            <div className='pl-10 pt-20 pb-10 '>
                <ol className="relative border-l border-black dark:border-gray-700">
                    <li className="mb-10 ml-4">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Sign Up and create your own Shop.</h3>
                    ...
                    <li className="mb-10 ml-4">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Fill in your details regarding what service you are providing</h3>
                    </li>
                    <li className="ml-4">
                        <div className="absolute w-3 h-3 bg-black rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
