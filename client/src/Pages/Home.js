            ...
            <div className='pl-10 pt-20 pb-10 '>
                <ol class="relative border-l border-black dark:border-gray-700">
                    ...
                    <li class="mb-10 ml-4">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-black">Fill in your details regarding what service you are providing</h3>
                    </li>
                    <li class="ml-4">
                        <div className="absolute w-3 h-3 bg-black rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                        <p className="mb-1 text-sm font-normal leading-none text-black dark:text-gray-500">Step 3</p>
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-black">Start your journey !!</h3>
                    </li>
                </ol>
            </div>
        </div>
